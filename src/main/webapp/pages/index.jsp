...
<% if (request.getAttribute("showLoginModal") != null && Boolean.TRUE.equals(request.getAttribute("showLoginModal"))) { %>
<script>
...
<% } %>
<script>
    // Only attach to add-to-cart buttons, not all .bg-blue-600 buttons
