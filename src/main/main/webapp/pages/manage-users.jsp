            ...
            <table class="w-full table-auto border-collapse">
              ...
              <c:forEach var="user" items="${users}">
                <tr>
                  ...
                  <td class="border px-4 py-3 text-gray-600"><c:out value="${user.address}"/></td>
                  ...
                  <td class="border px-4 py-3">
                    <button onclick="openEditModal('<c:out value="${user.fullName}"/>', '<c:out value="${user.username}"/>', '<c:out value="${user.role}"/>', '<c:out value="${user.email}"/>', '<c:out value="${user.contactNo}"/>', '<c:out value="${user.address}"/>', '<fmt:formatDate value="${user.birthday}" pattern="yyyy-MM-dd"/>', '<c:out value="${user.gender}"/>')" class="text-blue-600 hover:text-blue-800 mr-3">
      ...
      <div class="modal-content">
        ...
        <form id="addUserForm" action="${pageContext.request.contextPath}/ManageUsersServlet" method="post" onsubmit="return validateUserForm('addUserForm')">
          ...
          <div class="mb-5">
            ...
            <input type="password" name="password" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" minlength="8">
          </div>
          <div class="mb-5">
          ...
          <div class="mb-5">
            ...
            <input type="text" name="contactNo" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" pattern="[0-9]{10,15}">
          </div>
          <div class="mb-5">
          ...
          <div class="mb-5">
            ...
            <input type="date" name="birthday" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
          </div>
          <div class="mb-5">
    ...
    <div id="editUserModal" class="modal">
      <div class="modal-content">
        ...
        <form id="editUserForm" action="${pageContext.request.contextPath}/ManageUsersServlet" method="post" onsubmit="return validateUserForm('editUserForm')">
          ...
          <div class="mb-5">
            <label class="block text-gray-700 font-medium mb-1">Username</label>
            <input type="text" name="username" id="editUsername" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" maxlength="50" pattern="[a-zA-Z0-9_]+" readonly>
          </div>
          <div class="mb-5">
            <label class="block text-gray-700 font-medium mb-1">Password</label>
            <input type="password" name="password" id="editPassword" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" minlength="8">
          </div>
          <div class="mb-5">
            <label class="block text-gray-700 font-medium mb-1">Role</label>
          ...
          <div class="mb-5">
            <label class="block text-gray-700 font-medium mb-1">Contact Number</label>
            <input type="text" name="contactNo" id="editContactNo" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" pattern="[0-9]{10,15}">
          </div>
          <div class="mb-5">
            <label class="block text-gray-700 font-medium mb-1">Address</label>
          ...
          <div class="mb-5">
            <label class="block text-gray-700 font-medium mb-1">Birthday</label>
            <input type="date" name="birthday" id="editBirthday" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
          </div>
          <div class="mb-5">
            <label class="block text-gray-700 font-medium mb-1">Gender</label>
...
<script>
  ...
  function openEditModal(fullName, username, role, email, contactNo, address, birthday, gender) {
